...
namespace Zipper
{
    ...
    public class ZipEncryption
    {
        ...
        #region Events
        /// <summary>
        /// Event for occurrence Errors.
        /// </summary>
        public event ErrorEventHandler ErrorOccurrence;

        /// <summary>
        /// Event for occurrence Reports.
        /// </summary>
        public event EventHandler<ReportEventArgs> ReportOccurrence;
        ...
        public event EventHandler<ZipErrorEventArgs> ZipError = delegate { };
        ...
        protected ZipFile EncryptedZipFile(ZipFile zip)
        {
            ...
            zip.ZipError += (source, e) => this.ZipError(source, e);
        ...
        public void ZipDirectory(string sourceFolder, string targetPath, CancellationTokenSource CTS)
        {
            ...
            {
                ReportOccurrence(this, new ReportEventArgs("ZipEncryption.ZipDirectory", "Cancellation Requested"));
                return;
            }
            try
            {
            ...
            catch (Exception ex) { ErrorOccurrence(this, new ErrorEventArgs(ex)); }
        }
        ...
        public void ZipFiles(List<FileInfo> sourceFiles, string toPath, System.Threading.CancellationTokenSource CTS)
        {
            try
            {
                if (CTS.IsCancellationRequested)
                {
                    ReportOccurrence(this, new ReportEventArgs("ZipEncryption.ZipFiles", "Cancellation Requested"));
                    return;
                }
                //
        ...
        public void UnZip(string ExistingZipFile, string TargetDirectory, CancellationTokenSource CTS)
        {
            try
            {
                if (CTS.IsCancellationRequested)
                {
                    ReportOccurrence(this, new ReportEventArgs("ZipEncryption.UnZip", "Cancellation Requested"));
                    return;
                }
